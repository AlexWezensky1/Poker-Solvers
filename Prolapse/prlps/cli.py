"""Command line front end for the Prolapse equity solver."""
...
def build_parser():
    parser = argparse.ArgumentParser(
        prog="prlps",
        description="Prolapse equity calculator.",
        epilog="example: prlps AsKsQsJsTs 2h3h4h5h6h --board '2c3c4c5c 7h8h9h'",
    )
    parser.add_argument(
